...
def Network_config(class_num=5, epoch=200, initial_epoch=0, batch_size=32,
...
def main():
    # Network_config()
    data = creat_list('/home/njtech/Jiannan/DL4ETI/DL4ETI-master/DL4ETI/CreateRandomList/two_tea_grades_list.txt')
    cross_validation(data, K=10, epoch=200, class_num=5, batch_size=32)
main()
